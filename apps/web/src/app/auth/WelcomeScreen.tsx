    ...
    <div className="relative flex h-auto min-h-screen w-full flex-col dark group/design-root overflow-x-hidden bg-background-dark">
      ...
      <div className="flex flex-col gap-y-4 px-4 pb-8 pt-8">
        <div className="flex px-4 py-3 justify-center">
            <Link href="/auth/signup" passHref className="flex min-w-[84px] max-w-[480px] cursor-pointer items-center justify-center overflow-hidden rounded-full h-12 px-5 flex-1 bg-primary text-[#112217] text-base font-bold leading-normal tracking-[0.015em]">
                <span className="truncate">Create Account</span>
            </Link>
        </div>
        <div className="flex px-4 py-3 justify-center">
            <Link href="/auth/login" passHref className="flex min-w-[84px] max-w-[480px] cursor-pointer items-center justify-center overflow-hidden rounded-full h-12 px-5 flex-1 bg-[#23482f] text-white text-base font-bold leading-normal tracking-[0.015em]">
        ...
        <div className="flex flex-col items-center justify-center pt-4">
          ...
          <div className="flex gap-x-6">
            <button onClick={signInWithGoogle} className="flex h-12 w-12 items-center justify-center rounded-full bg-[#23482f]">
            ...
            <button className="flex h-12 w-12 items-center justify-center rounded-full bg-[#23482f]">
              <svg aria-hidden="true" className="h-6 w-6 text-white" fill="currentColor" viewBox="0 0 24 24">
