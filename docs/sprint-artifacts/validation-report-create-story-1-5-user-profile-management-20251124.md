...
**Document:** docs/sprint-artifacts/1-5-user-profile-management.md
...
Evidence: "Learnings from Previous Story" subsection in Dev Notes, citing `docs/sprint-artifacts/1-4-conversational-onboarding-for-goal-setting.md`.
