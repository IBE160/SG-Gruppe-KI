...
**Document:** docs/sprint-artifacts/2-2-ai-daily-plan-generation.md
...
Evidence: "Learnings from Previous Story" subsection in Dev Notes, citing `docs/sprint-artifacts/2-1-context-window-for-daily-input.md`.
