...
**Document:** docs/sprint-artifacts/2-7-simulated-recovery-inputs.md
...
Evidence: "Learnings from Previous Story" subsection in Dev Notes, citing `docs/sprint-artifacts/2-6-basic-progress-dashboard.md`.
