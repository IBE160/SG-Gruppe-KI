...
**Document:** docs/sprint-artifacts/3-4-in-app-reminders-and-nudges.md
...
Evidence: "Learnings from Previous Story" subsection in Dev Notes, citing `docs/sprint-artifacts/3-3-bpm-matched-session-mix-generation.md`.
