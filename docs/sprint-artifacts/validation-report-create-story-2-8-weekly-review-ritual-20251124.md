...
**Document:** docs/sprint-artifacts/2-8-weekly-review-ritual.md
...
Evidence: "Learnings from Previous Story" subsection in Dev Notes, citing `docs/sprint-artifacts/2-7-simulated-recovery-inputs.md`.
