...
*   **Sizes:** Small, Medium (default), Large – affecting padding, font sizes, and overall dimensions.
*   **Styles:** Primary, Secondary, Ghost, Outline – aligning with button hierarchy and visual weight.
